...
town_name_table[TOWN.ASGRARD = 1] = '阿斯嘉特';
...
// 阿斯嘉特
area_table[TOWN.ASGRARD] = {};
{
	// 法理斯廣場
	area_table[TOWN.ASGRARD][AREA.FALISU] = clone_hash(AREA_TEMPLATE, {
		town_id: TOWN.ASGRARD, 
		area_id: AREA.FALISU, 
	...
	// 商業區
	area_table[TOWN.ASGRARD][AREA.BUSINESS] = clone_hash(AREA_TEMPLATE, {
		town_id: TOWN.ASGRARD, 
		area_id: AREA.BUSINESS, 
		background_image: IMAGE.BG_CASTLE, 
		options: [
	...
	// 冒險者公會
	area_table[TOWN.ASGRARD][AREA.GUILD] = clone_hash(AREA_TEMPLATE, {
		town_id: TOWN.ASGRARD, 
		area_id: AREA.GUILD, 
		background_image: IMAGE.BG_CASTLE, 
		options: [
