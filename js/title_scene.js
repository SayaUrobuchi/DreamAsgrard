...
function TitleScene ()
{
	...
	self.text_text = UI.TITLE_PRODUCER_TEXT;
	self.title_text = UI.TITLE_GAME_TITLE;
	self.title_option = [
	{
		name: UI.TITLE_OPTION_NEW_GAME, 
		id: TITLE_OPTION.NEW_GAME, 
	}, 
	{
		name: UI.TITLE_OPTION_CONTINUE, 
		id: TITLE_OPTION.LOAD_GAME, 
	}, 
	{
		name: UI.TITLE_OPTION_EXTRA, 
	...
	self.update = function ()
	{
		...
		case TITLE.END:
			self.deinit();
			// TODO: above is WRONG. it replaced SCENE_MAID!
			scene = ADVScene();
